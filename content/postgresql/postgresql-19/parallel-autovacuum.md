...
PostgreSQL 13 added `VACUUM (PARALLEL N)` for manual vacuum operations. PostgreSQL 19 extends this to autovacuum, letting the background vacuum workers spawn parallel helpers for index processing.
